...
| User and server ids are never reused (`AUTOINCREMENT`, schema 4) | an id kept anywhere, in a session, a live connection or an admin page, names that row or nothing |
